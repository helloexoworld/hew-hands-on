...
## [previous step]({{ site.baseurl }}/step-5-Process-all-stars/5.2-Optimize-global-analysis/) ... [solutions]({{ site.baseurl }}/step-5-Process-all-stars/5.3-Reformat-the-output/) ... [next step]({{ site.baseurl }}/step-6-Going-further/)